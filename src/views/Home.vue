<template>
  ...
  <el-carousel class="swiper-container" type="card" height="20vw" :interval="4000">
    <el-carousel-item v-for="(item, index) in swiperTaylorList" :key="index">
      <img :src="item.picImg" />
    </el-carousel-item>
  </el-carousel>
  <sheet></sheet>
...
import { swiperTaylorList, NavName } from "@/enums";
import { HttpManager } from "@/api";
import mixin from "@/mixins/mixin";

import Sheet from "@/components/layouts/Sheet.vue"
import SelfIntroduction from "@/components/layouts/SelfIntroduction.vue";
